...
namespace CardsAgainstDiscord.Migrations
{
    ...
    [Migration("20220209164526_AddSelectedWinnerIdToGames")]
    partial class AddSelectedWinnerIdToGames
    {
            ...
            modelBuilder.Entity("CardsAgainstDiscord.Model.PickedCard", b =>
                {
                    ...
                    b.HasIndex("GameId")
                        .HasDatabaseName("ix_picks_game_id");
            ...
            modelBuilder.Entity("CardsAgainstDiscord.Model.PickedCard", b =>
                {
                    b.HasOne("CardsAgainstDiscord.Model.Game", null)
                        ...
                        .HasConstraintName("fk_picks_games_game_id");
